  ...
  <section class="gig-reviews">
    ...
    <div class="breakdown">
      <div class="statistics">
        <table>
          <tbody>
            <tr :class="{dim:!ratings[5]}">
              <td class="rating-tag">
                <span> 5 Stars </span>
              </td>
              <td class="progress-bar-container">
                <div class="progress-bar">
                  <span :style="getWidth(ratings[5])"></span>
                </div>
              </td>
              <td class="rating-amount">({{ ratings[5] }})</td>
            </tr>
            <tr :class="{dim:!ratings[4]}">
              <td class="rating-tag">
                <span> 4 Stars </span>
              </td>
              <td class="progress-bar-container">
                <div class="progress-bar">
                  <span :style="getWidth(ratings[4])"></span>
                </div>
              </td>
              <td class="rating-amount">({{ ratings[4] }})</td>
            </tr>
            <tr :class="{dim:!ratings[3]}">
              <td class="rating-tag">
                <span> 3 Stars </span>
              </td>
              <td class="progress-bar-container">
                <div class="progress-bar">
                  <span :style="getWidth(ratings[3])"></span>
                </div>
              </td>
              <td class="rating-amount">({{ ratings[3] }})</td>
            </tr>
            <tr :class="{dim:!ratings[2]}">
              <td class="rating-tag">
                <span> 2 Stars </span>
              </td>
              <td class="progress-bar-container">
                <div class="progress-bar">
                  <span :style="getWidth(ratings[2])"></span>
                </div>
              </td>
              <td class="rating-amount">({{ ratings[2] }})</td>
            </tr>
            <tr :class="{dim:!ratings[1]}">
              <td class="rating-tag">
                <span> 1 Star </span>
              </td>
              <td class="progress-bar-container">
                <div class="progress-bar">
                  <span :style="getWidth(ratings[1])"></span>
                </div>
              </td>
              <td class="rating-amount">({{ ratings[1] }})</td>
            </tr>
          </tbody>
        </table>
      </div>
    ...
    <div class="details-reviews">
      <ul>
        <li v-for="review in gig.reviews" :key="review._id">
          <img class="review-pic" :src="review.userCLogo" alt="" />
          <header>
            ...
            <div class="review-country">
              <img :src="review.userCFlag" alt="" />
              <div>{{ review.userCountry }}</div>
            </div>
          </header>
          <p class="review-txt">{{ review.txt }}</p>
          <time>Published {{ reviewTime(review.reviewedAt) }} ago</time>
...
export default {
  ...
  methods: {
    getWidth(num) {
      return { width: (num * 100) / this.gig.reviews.length + "%" };
    },
    reviewTime(time) {
      const timeSince = new Date() - time;
      if (timeSince < 86400000) {
        if (Math.floor(timeSince / 3600000) === 1) {
          return Math.floor(timeSince / 3600000) + " hour";
        } else return Math.floor(timeSince / 3600000) + " hours";
      } else if (timeSince < 2592000000) {
        if (Math.floor(timeSince / 86400000) === 1) {
          return Math.floor(timeSince / 86400000) + " day";
        } else return Math.floor(timeSince / 86400000) + " days";
      } else if (timeSince >= 2592000000) {
        if (Math.floor(timeSince / 2592000000) === 1) {
          return Math.floor(timeSince / 2592000000) + " month";
        } else return Math.floor(timeSince / 2592000000) + " months";
      }
    },
    setRatings() {
      var ratings = {
